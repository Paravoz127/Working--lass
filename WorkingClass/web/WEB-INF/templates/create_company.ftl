...
<#macro info>
    <div class="pers-info">
        <form class="pers-info" action="/WorkingClass_war_exploded/create_company" method="POST" enctype="multipart/form-data">
            ...
            <input autocomplete="off" class="name" placeholder="Enter company name" name="name"/>
            <label class="txt" for="work-info">Info:</label>
            <textarea autocomplete="off" class="info-comp" placeholder="Enter Information about company" name="info"></textarea>
