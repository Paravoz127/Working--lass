package kpfu.itis.group11_801.kilin.workingClass.servlets.createFactorServletPackage;
...
@WebServlet(name = "CreateNewFactorServlet")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (request.getSession().getAttribute("user") == null) {
            ...
            try {
                ...
                Helpers.render(request, response, "create_new_factor.ftl", root);
            } catch (Exception e) {
                e.printStackTrace();
                response.sendRedirect("/WorkingClass_war_exploded/promotions");
            }
